...
@Autonomous
public class AuSmlpLejos extends OpMode {
    ...
    private final Pose pickUp5SamplePose = new Pose(80, 104, Math.toRadians(270));
    private final Pose pickUp5SampleControlPose = new Pose(70, 125, Math.toRadians(275));

    private final Pose put5OneSamplePose = new Pose(58, 124, Math.toRadians(315));
    private final Pose put5TwoSamplePose = new Pose(14, 129, Math.toRadians(315));
