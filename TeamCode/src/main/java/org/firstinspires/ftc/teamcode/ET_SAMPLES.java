...
@TeleOp(name = "ETESITO_SAMPLES")

public class ET_SAMPLES extends OpMode {
    ...
    public void loop() {
        ...
        double botHeading = etesito.imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.RADIANS) + Etesito.headingAuto + correctionZero;

        if (botHeading >= (4 * Math.PI)){
            botHeading -= (4 * Math.PI);
