...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 75.75; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -65.05; // x position of the perpendicular encoder (in tick units)
    }
