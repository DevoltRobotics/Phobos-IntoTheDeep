...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2160; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1853; // x position of the perpendicular encoder (in tick units)
    }
