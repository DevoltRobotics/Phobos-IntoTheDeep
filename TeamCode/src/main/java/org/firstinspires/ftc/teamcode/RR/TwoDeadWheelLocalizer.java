...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2021; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1950; // x position of the perpendicular encoder (in tick units)
    }
