...
@Autonomous
public class AuSmlpCerca extends OpMode {
    ...
    private final Pose pickUp5SamplePose = new Pose(59, 105, Math.toRadians(270));
    private final Pose pickUp5SampleControlPose = new Pose(62, 125, Math.toRadians(275));

    private final Pose put5OneSamplePose = new Pose(56, 124, Math.toRadians(315));
